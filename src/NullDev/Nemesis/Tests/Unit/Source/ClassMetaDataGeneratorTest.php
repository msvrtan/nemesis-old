...
class ClassMetaDataGeneratorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGenerate()
    {
        ...
        $mockFactory             = m::mock('NullDev\Nemesis\Source\ClassMetaDataFactory');
        ...
        $obj = new ClassMetaDataGenerator($mockFactory, $mockFileParser, $mockFileLoader, $mockReflectionGenerator);
